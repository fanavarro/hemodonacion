...
public class TestClassifierResult {
	...
	public TestClassifierResult(Evaluation evaluation, String datasetName, Classifier classifier, Instances dataset, int iteration) {
		super();
	...
	public String toString() {
		...
		sb.append(datasetName.replaceAll("-", "\t")).append("\t");
	...
	public String getHeader() {
		...
		header.append("Evaluation Method\t");
		header.append("Search Method\t");
